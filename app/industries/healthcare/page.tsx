...
export const metadata: Metadata = {
  ...
  description:
    "HIPAA-compliant digital marketing for medical practices, dental offices, med spas, psychiatry & mental health practices, and clinics in Nashville. Average 127% increase in appointment bookings. Free strategy session.",
}
          ...
          <BlurFade delay={0.1} inView>
            <div className="text-center">
              ...
              <p className="text-white text-lg max-w-2xl mx-auto mb-10">
                Nashville Digital Group helps medical practices, dental offices, med spas, psychiatry & mental health
                practices, and clinics fill their schedules with HIPAA-compliant marketing that actually converts.
              </p>
          ...
          <BlurFade delay={0.1} inView>
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-slate-900 tracking-tight">
                ...
                <span className="text-sky-600">Back</span>
              </h2>
            </div>
          </BlurFade>
          ...
          <BlurFade delay={0.1} inView>
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-slate-900 tracking-tight">
                ...
                <span className="text-sky-600">Your Practice</span>
              </h2>
            </div>
          </BlurFade>
